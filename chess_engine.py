...
class Engine:
    ...
    def __init__(self, fen):
        ...
        #weight for static evaluating functions
        ...
        #setting the required pattern in the board using set_fen() method
        self.board.set_fen(fen)
        self.leaves_reached = 0

    #random_responce  method which is called from js file  for generating a move by bot
